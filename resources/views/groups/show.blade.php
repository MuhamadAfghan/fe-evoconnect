                            ...
                            <table class="table-borderless mb-0 table">
                                <tbody>
                                    <tr class="border-bottom">
                                        ...
                                        <td class="p-3">{{ $group->created_at->diffForHumans() }}</td>
                                    </tr>
                                    <tr class="border-bottom">
                    ...
                    <div class="box mb-3 rounded border bg-white shadow-sm">
                        ...
                        <div class="box-body p-0">
                            ...
                            <div class="border-bottom p-3">
                                <div class="d-flex align-items-center mb-3">
                                    <img src="{{ asset('default-user.png') }}" class="rounded-circle mr-2"
                            ...
                            <div class="d-flex flex-wrap">
                                @foreach ($group->members as $member)
                                    <div class="m-2 text-center">
                                        <img src="{{ $member->user->profile_photo ? asset('storage/' . $member->user->profile_photo) : asset('default-user.png') }}"
