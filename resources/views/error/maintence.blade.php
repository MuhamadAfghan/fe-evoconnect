...
@section('content')
        ...
        <div class="container">
            <div class="row align-items-center vh-100">
                <div class="col-md-12 text-center">
                    <svg class="mb-5" id="c72640af-2824-4ace-a782-4df73f48977c" data-name="Layer 1"
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="300"
                        viewBox="0 0 1143.14 862.91">
                        <defs>
                            <linearGradient id="969f2d34-5bff-4fc3-8c31-c6509eddc389" x1="551.46" y1="688.44"
                                x2="551.46" y2="150.11" gradientUnits="userSpaceOnUse">
                                <stop offset="0" stop-color="gray" stop-opacity="0.25" />
                                <stop offset="0.54" stop-color="gray" stop-opacity="0.12" />
                                <stop offset="1" stop-color="gray" stop-opacity="0.1" />
                            </linearGradient>
                            <linearGradient id="488cd128-ff9c-494f-bd41-35fb6c1caf21" x1="1059.46" y1="856.62"
                                x2="1059.46" y2="468.94" xlink:href="#969f2d34-5bff-4fc3-8c31-c6509eddc389" />
                            <linearGradient id="ccb18d0b-874b-442a-b8cb-57bcf76cdeb5" x1="814.74" y1="881.34"
                                x2="814.74" y2="496.8"
                                gradientTransform="matrix(-1, -0.04, -0.04, 1, 1070.86, 21.29)"
                                xlink:href="#969f2d34-5bff-4fc3-8c31-c6509eddc389" />
                        </defs>
                        <title>content</title>
                        <ellipse cx="1023.75" cy="834.07" rx="100.11" ry="24.73" fill="#007bff"
                            opacity="0.1" />
                        <ellipse cx="140.04" cy="838.19" rx="100.11" ry="24.73" fill="#007bff"
                            opacity="0.1" />
                        <path
                            ...
                            transform="translate(-28.43 -18.54)" fill="#007bff" />
                        <path
                        ...
                        <path d="M631,175.34s-20.26,25-18.77,47.75" transform="translate(-28.43 -18.54)" fill="none"
                            stroke="#444053" stroke-miterlimit="10" />
                        <path d="M595.48,185.15s-20.13,19.24-17.56,29.95" transform="translate(-28.43 -18.54)"
                        ...
                        <path d="M548.8,91.91s22.33,47.93,38.54,54" transform="translate(-28.43 -18.54)" fill="none"
                            stroke="#444053" stroke-miterlimit="10" />
                        <path d="M572.22,69.08s13.72,44.09,30.71,57.85" transform="translate(-28.43 -18.54)"
                            fill="none" stroke="#444053" stroke-miterlimit="10" />
                        <path d="M673.39,111.19s-36.19,15.53-57.92-.18" transform="translate(-28.43 -18.54)"
                        ...
                        <path d="M541.39,166.15s0,28.25-7.69,30.26" transform="translate(-28.43 -18.54)" fill="none"
                            stroke="#444053" stroke-miterlimit="10" />
                        <path d="M478.52,202.75s30.54,2.62,44.63-13.14" transform="translate(-28.43 -18.54)"
                            fill="none" stroke="#444053" stroke-miterlimit="10" />
                        <path d="M533.51,132.78s-7.39,28.65-27.78,36.37" transform="translate(-28.43 -18.54)"
                            fill="none" stroke="#444053" stroke-miterlimit="10" />
                        ...
                        <path
                            ...
                            transform="translate(-28.43 -18.54)" fill="#007bff" opacity="0.1" />
                        <rect x="76.29" y="150.11" width="950.33" height="538.33" rx="12.49" ry="12.49"
                            fill="url(#969f2d34-5bff-4fc3-8c31-c6509eddc389)" />
                        <rect x="77.8" y="157.68" width="947.42" height="528.97" rx="12.49" ry="12.49"
                            fill="#fff" />
                        <rect x="77.8" y="157.68" width="947.42" height="528.97" rx="12.49" ry="12.49"
                            fill="#fff" />
                        <rect x="77.8" y="157.68" width="947.42" height="528.97" rx="12.49" ry="12.49"
                            fill="#5a5773" opacity="0.04" />
                        <path
                        ...
                        <rect x="141.22" y="293.86" width="790" height="392.78" rx="10.19" ry="10.19"
                            fill="#fff" />
                        <rect x="107.72" y="203.45" width="227.24" height="23.85" rx="3.86" ry="3.86"
                            fill="#5a5773" opacity="0.2" />
                        <rect x="536.22" y="339.45" width="227.24" height="23.85" rx="3.86" ry="3.86"
                            fill="#007bff" opacity="0.2" />
                        <rect x="536.22" y="406.23" width="354.83" height="23.85" rx="3.86" ry="3.86"
                            fill="#007bff" opacity="0.2" />
                        <rect x="536.22" y="445.23" width="354.83" height="23.85" rx="3.86" ry="3.86"
                            fill="#007bff" opacity="0.2" />
                        <rect x="536.22" y="484.23" width="354.83" height="23.85" rx="3.86" ry="3.86"
                            fill="#007bff" opacity="0.2" />
                        <rect x="536.22" y="523.23" width="354.83" height="23.85" rx="3.86" ry="3.86"
                            fill="#007bff" opacity="0.2" />
                        <rect x="184.05" y="566.23" width="707" height="23.85" rx="3.86" ry="3.86"
                            fill="#007bff" opacity="0.2" />
                        <rect x="184.05" y="605.23" width="707" height="23.85" rx="3.86" ry="3.86"
                            fill="#007bff" opacity="0.2" />
                        <rect x="184.05" y="644.23" width="707" height="23.85" rx="3.86" ry="3.86"
                            fill="#007bff" opacity="0.2" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-28.43 -18.54)" fill="#ffd037" />
                        <ellipse cx="713.64" cy="758.15" rx="62" ry="9.51" fill="#007bff"
                            opacity="0.1" />
                        <path
                        ...
                        <polygon points="744.07 710.01 743.65 713.43 683.62 713.43 683.21 710.01 744.07 710.01"
                            fill="#9d9cb5" />
                        <rect x="184.05" y="326.22" width="302" height="221.54" rx="8.5" ry="8.5"
                            fill="#007bff" opacity="0.2" />
                        <path
                        ...
                        <path d="M1067.8,816.26s12,2,12.4,4.35S1067.8,816.26,1067.8,816.26Z"
                            transform="translate(-28.43 -18.54)" opacity="0.1" />
                        <path d="M1074.46,760.53s11,2.59,11.67,4.35Z" transform="translate(-28.43 -18.54)"
                            opacity="0.1" />
                        ...
                        <path d="M1132.23,569.37s-7.78,5.74-6.11,7.6S1132.23,569.37,1132.23,569.37Z"
                            transform="translate(-28.43 -18.54)" opacity="0.1" />
                        <path d="M1132.6,593.07s14.44-4.63,15.92,0Z" transform="translate(-28.43 -18.54)"
                            opacity="0.1" />
                        <path
                        ...
                        <rect x="849.12" y="551.42" width="181.18" height="208.22" rx="6.61" ry="6.61"
                            fill="#fff" />
                        <rect x="849.12" y="551.42" width="181.18" height="208.22" rx="6.61" ry="6.61"
                            fill="#5a5773" opacity="0.1" />
                        <rect x="858.36" y="562.04" width="162.7" height="186.98" rx="6.61" ry="6.61"
                            fill="#fff" />
                        <rect x="882.03" y="599.54" width="111.62" height="38.52" rx="6.03" ry="6.03"
                            fill="#007bff" />
                        ...
                        <rect y="482.59" width="426.61" height="208.22" rx="6.61" ry="6.61" fill="#5a5773"
                            opacity="0.1" />
                        <rect x="21.76" y="493.21" width="383.08" height="186.98" rx="6.61" ry="6.61"
                            fill="#fff" />
                        <rect x="77.51" y="530.72" width="262.81" height="38.52" rx="6.03" ry="6.03"
                            fill="#007bff" />
                        ...
                        <path
                            ...
                            transform="translate(-28.43 -18.54)" opacity="0.1" />
                        <path d="M253.36,552.36s-4,14.81-13.15,19.54Z" transform="translate(-28.43 -18.54)"
                            opacity="0.1" />
                        ...
                        <path d="M174.51,532.1s-12.71-.47-15.68,4.18" transform="translate(-28.43 -18.54)"
                            opacity="0.1" />
                    </svg>
                    <h1 class="text-dark font-weight-bold">We're just tuning up a few things.</h1>
                    <p class="lead mb-5">We apologize for the inconvenience but Front is currently undergoing planned
                        maintenance.
                    </p>
                    <a href="{{ route('home') }}" class="btn btn-primary btn-lg"> Check for Updates </a>
    ...
    <footer class="fixed-bottom bg-white py-4">
        <div class="container">
