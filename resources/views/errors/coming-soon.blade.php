    ...
    <div class="vh-100 bg-white">
        <div class="container">
            <div class="row align-items-center vh-100">
                <div class="col-md-6">
                    <svg class="w-100" id="e43251fe-2b99-4b63-8176-d5da4893f038" data-name="Layer 1"
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1177.82 724.47">
                ...
                <div class="col-md-6 pl-5">
                    <h1 class="text-primary font-weight-light">We're coming <span class="font-weight-bold">soon.</span>
                    </h1>
                    <p class="lead mb-5">Our website is under construction. We'll be here soon with our new awesome site,
                        subscribe to be notified.
                    </p>
                    <div class="row">
                        <div class="col">
                            <div class="mb-2 rounded border p-3 text-center">
                                <h5 class="font-weight-bold text-primary mb-1">322</h5>
                                <p class="text-dark mb-0">Days</p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="mb-2 rounded border p-3 text-center">
                        ...
                        <div class="col">
                            <div class="mb-2 rounded border p-3 text-center">
                                ...
                                <p class="text-dark mb-0">Mins</p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="mb-2 rounded border p-3 text-center">
                                <h5 class="font-weight-bold text-primary mb-1">43</h5>
                                <p class="text-dark mb-0">Secs</p>
                            </div>
                        </div>
                    </div>
                </div>
