    ...
    <div class="py-4">
        <div class="col-md-8 container mx-auto">
            <div class="row">
                <!-- Main Content -->
                <div class="col-md-6">
                    <div class="box mb-4 rounded border bg-white shadow-sm">
                        <div class="d-flex align-items-center p-4">
                            <i class="feather-message-circle display-4"></i>
                            <div class="ml-4">
                                <h5 class="font-weight-normal text-dark mb-3 mt-0">Help Forum</h5>
                                <p class="text-muted mb-0">Find the answer to any question, from the basics all the way to
                                    advanced tips and tricks!
                                    ...
                                </p>
                            </div>
                        </div>
                        <div class="border-top d-flex align-items-center overflow-hidden p-4">
                            <a class="font-weight-bold d-block" href="#"> EVOConnect Help Forum. </a>
                            <i class="feather-arrow-right-circle text-primary ml-auto"></i>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="box mb-4 rounded border bg-white shadow-sm">
                        <div class="d-flex align-items-center p-4">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-muted mb-0">Want to learn more about setting up and managing your team? Look
                                    no further!
                                    ...
                                </p>
                            </div>
                        ...
                        <div class="border-top d-flex align-items-center overflow-hidden p-4">
                            <a class="font-weight-bold d-block" href="#"> EVOConnect Safety Center. </a>
                            <i class="feather-arrow-right-circle text-primary ml-auto"></i>
                        </div>
                    </div>
                </div>
