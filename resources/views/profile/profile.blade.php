                ...
                <aside class="col col-xl-3 order-xl-1 col-lg-12 order-lg-1 col-12">
                    <div class="box profile-box mb-3 rounded border bg-white text-center shadow-sm">
                        ...
                        <div class="border-top overflow-hidden">
                            <a class="font-weight-bold d-block p-3" href=route('login')in') }}"> Log Out </a>
                        </div>
                    </div>
                    <div class="box mb-3 rounded border bg-white shadow-sm">
                        ...
                        <div class="box-body">
                            <div class="d-flex align-items-center osahan-post-header border-bottom people-list p-3">
                            ...
                            <div class="d-flex align-items-center osahan-post-header people-list p-3">
                                <div class="dropdown-list-image mr-3">
                                    <img class="rounded-circle" src="img/l5.png" alt="">
                                </div>
                                <div class="font-weight-bold">
                                    <div class="text-truncate">Adobe Photoshop <span class="badge badge-info ml-1">3</span>
                                    </div>
                                    <div class="small text-muted"><span class="text-primary">Julia Cox</span> has given an
                                        endorsement for this skill
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="box mb-3 rounded border bg-white shadow-sm">
                        ...
                        <div class="box-body p-3">
                            ...
                            <p class="mb-0">Find the most qualified people in the most unexpected places. Information for
                                applicants to consider when applying for local positions. The largest community on the web
                                to find and list jobs that aren't restricted by commutes or a specific location.
                            </p>
                        </div>
                    </div>
                    <div class="box mb-3 rounded border bg-white shadow-sm">
                        ...
                        <div class="box-body border-bottom p-3">
                            <div class="d-flex align-items-top job-item-header pb-2">
                                ...
                                <img class="img-fluid mb-auto ml-auto" src="img/l3.png" alt="">
                            </div>
                            <p class="mb-0">Find the most qualified people in the most unexpected places. Information for
                        ...
                        <div class="box-body border-bottom p-3">
                            <div class="d-flex align-items-top job-item-header pb-2">
                                ...
                                <img class="img-fluid mb-auto ml-auto" src="img/l6.png" alt="">
                            </div>
                        ...
                        <div class="box-body p-3">
                            <div class="d-flex align-items-top job-item-header pb-2">
                                ...
                                <img class="img-fluid mb-auto ml-auto" src="img/l2.png" alt="">
                            </div>
                            <p class="mb-0">Wualified people in the most unexpected places. Information for applicants to
                    ...
                    <div class="box mb-3 rounded border bg-white shadow-sm">
                        ...
                        <div class="box-body border-bottom p-3">
                            <div class="d-flex align-items-top job-item-header pb-2">
                                ...
                                <img class="img-fluid mb-auto ml-auto" src="img/e1.png" alt="">
                            </div>
                            <p class="mb-0">Find the most qualified people in the most unexpected places. Information for
                                applicants to consider when applying for local positions.</p>
                        </div>
                        <div class="box-body p-3">
                            <div class="d-flex align-items-top job-item-header pb-2">
                                ...
                                <img class="img-fluid mb-auto ml-auto" src="img/e2.png" alt="">
                            </div>
                            <p class="mb-0">Wualified people in the most unexpected places. Information for applicants to
