        ...
        <div class="container">
            <div class="row">
               <div class="col-md-12 mx-auto">
                  <h1 class="text-white font-weight-light"><span class="font-weight-bold">Osahanin</span> Blog</h1>
			...
			<div class="row">
               <div class="col-lg-4 col-md-4">
                 <div class="box shadow-sm rounded bg-white mb-3 blog-card border-0">
						...
						<div class="card-footer border-0">
                              <p class="mb-0"><img class="rounded-circle" src="img/user/3.jpg" alt="Card image cap"> <strong>Rahul Yadav</strong> On October 03, 2020</p>
                           </div>
						</a>
                     </div>
               </div>
			   <div class="col-lg-4 col-md-4">
                 <div class="box shadow-sm rounded bg-white mb-3 blog-card border-0">
						...
						<div class="card-footer border-0">
                              <p class="mb-0"><img class="rounded-circle" src="img/user/2.jpg" alt="Card image cap"> <strong>Rahul Yadav</strong> On October 05, 2020</p>
                           </div>
						</a>
                     </div>
               </div>
               <div class="col-lg-4 col-md-4">
                 <div class="box shadow-sm rounded bg-white mb-3 blog-card border-0">
						...
						<div class="card-footer border-0">
                              <p class="mb-0"><img class="rounded-circle" src="img/user/1.jpg" alt="Card image cap"> <strong>Rahul Yadav</strong> On October 06, 2020</p>
                           </div>
						</a>
                     </div>
               </div>
			...
			<div class="row">
               <div class="col-lg-4 col-md-4">
                 <div class="box shadow-sm rounded bg-white mb-3 blog-card border-0">
						...
						<div class="card-footer border-0">
                              <p class="mb-0"><img class="rounded-circle" src="img/user/4.jpg" alt="Card image cap"> <strong>Rahul Yadav</strong> On October 03, 2020</p>
                           </div>
						</a>
                     </div>
               </div>
			   <div class="col-lg-4 col-md-4">
                 <div class="box shadow-sm rounded bg-white mb-3 blog-card border-0">
						...
						<div class="card-footer border-0">
                              <p class="mb-0"><img class="rounded-circle" src="img/user/5.jpg" alt="Card image cap"> <strong>Rahul Yadav</strong> On October 05, 2020</p>
                           </div>
						</a>
                     </div>
               </div>
			...
			<div class="row">
			   ...
			   <div class="col-lg-4 col-md-4">
                 <div class="box shadow-sm rounded bg-white mb-3 blog-card border-0">
						...
						<div class="card-footer border-0">
                              <p class="mb-0"><img class="rounded-circle" src="img/user/3.jpg" alt="Card image cap"> <strong>Rahul Yadav</strong> On October 05, 2020</p>
                           </div>
						</a>
                     </div>
               </div>
               <div class="col-lg-4 col-md-4">
                 <div class="box shadow-sm rounded bg-white mb-3 blog-card border-0">
						...
						<div class="card-footer border-0">
                              <p class="mb-0"><img class="rounded-circle" src="img/user/2.jpg" alt="Card image cap"> <strong>Rahul Yadav</strong> On October 06, 2020</p>
                           </div>
						</a>
                     </div>
               </div>
