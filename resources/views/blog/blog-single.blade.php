         ...
         <div class="container">
            <div class="row">
               <div class="col-md-12 mx-auto">
                  <h1 class="text-white font-weight-light"><span class="font-weight-bold">Blog 
                  </span> Single</h1>
                        ...
                        <div class="row">
                           <div class="col-xl-10 offset-xl-1">
                              <blockquote class="margin-top-1x margin-bottom-1x">
                                 <p class="font-weight-bold">Perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo.</p>
	...
	<div class="media mb-4">
		  ...
		  <div class="media">
            ...
            <div class="media-body">
			  ...
			  <i class="feather-star text-warning"></i>
			  <i class="feather-star text-warning"></i>
			  <i class="feather-star text-warning"></i><small class="text-success">5/5</small>
			  </span></h5>
                  <p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
                </div>
              </div>
...
<div class="padding-card box shadow-sm rounded bg-white mb-3 border-0">
  ...
  <div class="card-body">
	...
	<hr>
	<a href="#"><h6>Nulla malesuada mauris non nulla imperdiet ullamcorper</h6></a>
	<p class="mb-0"><i class="feather-calendar"></i> June 20, 2020</p>
	<hr>
	<a href="#"><h6 class="text-dark">Focus on creating and growing your projects and websites</h6></a>
	<p class="mb-0"><i class="feather-calendar"></i> June 29, 2020</p>
	<hr>
	<a href="#"><h6>Vestibulum lobortis urna eu mauris viverra porttitor. Cras consequat </h6></a>
	<p class="mb-0"><i class="feather-calendar"></i> October 10, 2020</p>
	<hr>
	<a href="#"><h6>Sed lacinia varius nisi et euismod.</h6></a>
	<p class="mb-0"><i class="feather-calendar"></i> April 05, 2020</p>
