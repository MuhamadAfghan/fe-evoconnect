                                ...
                                <div class="col-lg-8 col-md-8">
                                    ...
                                    <div class="blog-card padding-card box mb-3 rounded border-0 bg-white shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="mb-3"><i class="feather-calendar"></i> March 09, 2020 / 3 Comments
                                            </h6>
                                            <p>
                                            ...
                                            <p>
                                                Praesent eget euismod nibh. Fusce ac tellus eu nisl lobortis maximus ac eget
                                                sapien. Nulla
                                                malesuada mauris non nulla imperdiet ullamcorper.
                                            </p>
                                            <p>Spacial has both a web app and an android app to make your website easy and
                                                always available.
                                                It offers you all the designs in collaboration with some smart people. Your
                                                projects will
                                            ...
                                            <div class="row">
                                                <div class="col-xl-10 offset-xl-1">
                                                    <blockquote class="margin-top-1x margin-bottom-1x">
                                                        <p class="font-weight-bold">Perspiciatis unde omnis iste natus error
                                                            sit voluptatem
                                            ...
                                            <p>
                                                Focus on creating and growing your projects and websites, and we‘ll take
                                                care of spinning up
                                                new designs for your users and making sure they’re great. Work with all
                                                types of customers
                                                right out of the box while still getting paid in your preferred currency.
                                            </p>
                                            <p class="mb-0">Sed porta libero metus, nec feugiat enim pharetra vel. Sed vel
                                                sagittis augue.
                                                Donec hendrerit nibh ac dolor lobortis, eu varius odio sollicitudin. Proin
                                                non condimentum
                                                nulla, quis dictum leo. Vestibulum lobortis urna eu mauris viverra
                                                porttitor. Cras consequat
                                                leo condimentum lacus viverra sollicitudin. Donec dignissim ornare est, nec
                                                scelerisque
                                                purus mollis eu. Phasellus dictum suscipit ligula. Donec malesuada gravida
                                                velit. Nulla
                                                egestas diam in ligula mollis, nec tincidunt diam porta. Proin eleifend
                                                lacinia diam quis
                                                pretium. Sed lacinia varius nisi et euismod. Ut ac arcu vulputate, porta
                                                nibh non, ultricies
                                    ...
                                    <div class="padding-card reviews-card box mb-3 rounded border-0 bg-white shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="media">
                                                ...
                                                <div
                                                    class="padding-card reviews-card box mb-3 rounded border-0 bg-white shadow-sm">

                                                    <div class="card-body">
                                                        <h5 class="card-title mb-4">3 Reviews</h5>
                                                        <div class="media mb-4">
                                                            <img class="d-flex mr-3 rounded" src="img/user/1.jpg"
                                                                alt="">
                                                            <div class="media-body">
                                                                <h5 class="mt-0">Stave Martin <small>Feb 12, 2020</small>
                                                                    {{-- <span class="star-rating float-right">
                                            ...
                                            <i class="feather-star text-warning"></i><small class="text-success">5/2</small>
                                                        ...
                                                        <div class="media">
                                                            <img class="d-flex mr-3 rounded" src="img/user/2.jpg"
                                                                alt="">
                                                            <div class="media-body">
                                            ...
                                            <i class="feather-star text-warning"></i><small class="text-success">5/1</small>
                                                                ...
                                                                <div class="media mt-4">
                                                                    <img class="d-flex mr-3 rounded" src="img/user/3.jpg"
                                                                        alt="">
                                                                    <div class="media-body">
                                                                        <h5 class="mt-0">Ryan Printz <small>Nov 13,
                                                                                2020</small> <span
                                                                                class="star-rating float-right">
                                                                                <i class="feather-star text-warning"></i>
                                                                                <i class="feather-star text-warning"></i>
                                                                                ...
                                                                                <i class="feather-star text-warning"></i>
                                                                                <i
                                                                                    class="feather-star text-warning"></i><small
                                                        ...
                                                        <div class="media mt-4">
                                                            <img class="d-flex mr-3 rounded" src="img/user/5.jpg"
                                                                alt="">
                                                            <div class="media-body">
                                    ...
                                    <div class="col-lg-4 col-md-4">
                                        ...
                                        <div class="sidebar-card box mb-3 rounded border-0 bg-white shadow-sm">
                                            <div class="card-body">
                                                ...
                                                <hr>
                                                <a href="#">
                                                    <h6 class="text-dark">Focus on creating and growing your projects and
                                                        websites</h6>
                                                </a>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div id="featured-properties" class="carousel slide"
                                                    ...
                                                    <ol class="carousel-indicators">
                                                        <li data-target="#featured-properties" data-slide-to="0"
                                                            class=""></li>
                                                        <li data-target="#featured-properties" data-slide-to="1"
                                                            class="active"></li>
                                                    </ol>
                                                            ...
                                                            <div class="job-item rounded border bg-white">
                                                                <div class="d-flex align-items-center job-item-header p-3">
                                                                    <div class="mr-2 overflow-hidden">
                                                                        <h6
                                                                            class="font-weight-bold text-dark text-truncate mb-0">
                                                                            Product
                                                                            Director</h6>
                                                                        <div class="text-truncate text-primary">Spotify
                                                                            Inc.</div>
                                                                        <div class="small text-gray-500"><i
                                                                                class="feather-map-pin"></i>
                                                                            India, Punjab</div>
                                                                    </div>
                                                                    <img class="img-fluid ml-auto" src="img/l3.png"
                                                                        alt="">
                                                                </div>
                                                                <div
                                                                ...
                                                                <div class="job-item-footer p-3">
                                                                    <small class="text-gray-500"><i
                                                                            class="feather-clock"></i> Posted 3 Days
                                                                        ago</small>
                                                                </div>
                                                            </div>
                                                        </div>
